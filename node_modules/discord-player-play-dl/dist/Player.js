    ...
    async search(query, options) {
        ...
        switch (qt) {
            ...
            case types_1.QueryType.YOUTUBE_SEARCH: {
                const videos = await play_dl_1.default
                    .search(query, {
                    limit: 10,
            ...
            case types_1.QueryType.SOUNDCLOUD_SEARCH: {
                const result = (await QueryResolver_1.QueryResolver.resolve(query)) === types_1.QueryType.SOUNDCLOUD_TRACK
                    ? [{ url: query }]
                    : await play_dl_1.default
                        .search(query, {
                        limit: 5,
